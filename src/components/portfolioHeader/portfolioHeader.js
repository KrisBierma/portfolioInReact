  ...
  <div>
    ...
    <div className="center">
      ...
      {/* <!-- <div className="port-grid"> --> */}
          ...
          <button className="btn portButtons" id="jQuery"><img className="myIcons" src={require("../../assets/images/jqueryIcon.png")}></img> jQuery</button>
          <button className="btn portButtons" id="Node.js"><img className="myIcons2" src={require("../../assets/images/nodeIcon.png")}/></button>
          {/* <!-- <button className="btn portButtons" id="Express">Express</button> --> */}
          <button className="btn portButtons" id="bootstrap"><img className="myIcons2" src={require("../../assets/images/bootstrapIcon2.png")}/></button>
          <button className="btn portButtons" id="handlebars"><img className="myIcons4" src={require("../../assets/images/hbsIcon2.png")}/>
              </button>
          <button className="btn portButtons" id="react"><img className="myIcons2" src={require("../../assets/images/reactIcon2.png")}/>
          </button>
          ...
          <button className="btn portButtons" id="firebase"><img className="myIcons4" src={require("../../assets/images/firebaseIcon.png")}/></button>
          {/* <!-- <button className="btn portButtons" id="passport">Passport</button> --> */}
          <button className="btn portButtons" id="MySQL"><img className="myIcons3" src={require("../../assets/images/mysqlIcon.png")}/></button>
          <button className="btn portButtons" id="Mongo"><img className="myIcons3" src={require("../../assets/images/mongoIcon.png")}/></button>
          <button className="btn portButtons" id="Heroku"><img className="myIcons4" src={require("../../assets/images/herokuIcon.png")}/></button>
          <button className="btn portButtons" id="Full Stack"><img className="myIcons4" src={require("../../assets/images/fullStackIcon.png")}/>Full Stack</button>
      {/* <!-- </div> --> */}
      </div>
